...
import { VibeCoderProfileForm } from "@/components/onboarding/vibe-coder-profile-form"
import { createClient } from "@/lib/supabase/client"
import { toast } from "@/components/ui/use-toast"

export default function VibeCoderOnboardingPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">Complete Your Vibe Coder Profile</h1>
        <p className="text-muted-foreground">Let's set up your profile so you can start posting tasks.</p>
      </div>
