...
import { ArrowLeft, MessageSquare, FileCode, Settings, Users2, Clock, DollarSign, Sparkles, Edit } from "lucide-react"
import Link from "next/link"
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip"

export default function VibeCoderTaskSpacePage() {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button variant="outline" size="sm" asChild>
              <Link href="/all-screens">
                <ArrowLeft className="mr-2 h-4 w-4" />
                Back to All Screenss
              </Link>
            </Button>
            <h1 className="text-2xl font-bold tracking-tight">Vibe-Coder Task Space</h1>
          </div>
