      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg">Suggested Steps to Complete This Task</CardTitle>
          </div>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p className="text-xs">Generated by VibeAlong AI based on task description</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
              ...
              {steps.map((step, index) => (
                <li key={index} className={`text-sm ${step.completed ? "text-muted-foreground" : ""}`}>
                  <div className="flex items-start gap-2">
                    ...
                    <Button variant="ghost" size="sm" className="h-6 px-2" onClick={() => toggleStepCompletion(index)}>
